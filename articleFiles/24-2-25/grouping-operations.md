...
We have already discussed various aggregation functions. To refresh your memory about aggregation, read [Aggregation Operations](@/docs/spark/aggregations.md) article.
...
### Related Articles
- [Aggregation Operations](@/docs/spark/aggregations.md)
